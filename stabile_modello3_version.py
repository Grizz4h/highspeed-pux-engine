...
def save_spieltag_json(season: int, gameday: int, results: List[Dict[str, Any]], nord: pd.DataFrame, sued: pd.DataFrame, stats: pd.DataFrame) -> None:
    """Wrapper, um Kompatibilität zu wahren (verwendet `_save_json`)."""
    payload = {
